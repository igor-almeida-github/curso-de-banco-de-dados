...
INSERT INTO medicos (nome, crm) VALUES ('Fernanda Silva', '123123MG');
INSERT INTO medicos (nome, crm) VALUES ('Juliana Santana', '56565SC');
...
INSERT INTO clientes(nome, endereco, telefone, cep, localidade, cpf) 
    VALUES ('Agelina Jolie', 'Rua do Ipiranga, 456', '(21) 7544-3234', '56.654-567', 'Rio de Janeiro', '345.678.234-12');
INSERT INTO clientes(nome, endereco, telefone, cep, localidade, cpf) 
    VALUES ('Ricardo Chavez', 'Rua Certa, 678', '(21) 2678-3984', '12.456.223', 'Planaltina', '789.123.445-31');

-- Produtos
INSERT INTO produtos (produto, designacao, composicao, preco_de_venda, id_tipo_produto, id_fabricante) 
